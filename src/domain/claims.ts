...
export const defaultBlockedClaims: readonly ClaimRule[] = [
  ...
  {
    id: "claim-body-wash-kills-all-bacteria",
    phrase: "diệt sạch ổ vi khuẩn",
    status: "blocked",
    replacement: "hỗ trợ làm sạch và chăm sóc da có dầu thừa, mùi cơ thể",
    effectiveFrom: new Date("2026-08-26T00:00:00.000Z"),
  },
  {
    id: "claim-body-wash-sweat-100",
    phrase: "ức chế mồ hôi 100%",
    status: "blocked",
    replacement: "hỗ trợ kiểm soát mồ hôi khi dùng đúng hướng dẫn",
    effectiveFrom: new Date("2026-08-26T00:00:00.000Z"),
  },
  {
    id: "claim-body-wash-root-cause",
    phrase: "triệt tiêu tận gốc",
    status: "blocked",
    replacement: "hỗ trợ chăm sóc mùi cơ thể và kiểm soát mồ hôi",
    effectiveFrom: new Date("2026-08-26T00:00:00.000Z"),
  },
  {
    id: "claim-body-wash-guaranteed-cure",
    phrase: "cam kết hết hẳn",
    status: "blocked",
    replacement: "hiệu quả có thể khác theo tình trạng da và cách sử dụng",
    effectiveFrom: new Date("2026-08-26T00:00:00.000Z"),
  },
  {
    id: "claim-body-wash-instant-acne",
    phrase: "làm xẹp ngay",
    status: "blocked",
    replacement: "không dùng mỹ phẩm để cam kết điều trị mụn viêm",
    effectiveFrom: new Date("2026-08-26T00:00:00.000Z"),
  },
];
